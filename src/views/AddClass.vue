    ...
    <div class="add-post-wrap">
        ...
        <div class="_40-side-padding">
          <div class="w-form">
            <form id="email-form" name="email-form" data-name="Email Form" class="form">
              ...
              <div class="_30px-bottom-margin"><textarea id="description-2" name="description-2" placeholder="Class description" maxlength="5000" data-name="Description 2" required="" class="form-text description w-input"></textarea></div>
              <div class="_30px-bottom-margin"><select id="field-2" name="field-2" required="" data-name="Field 2" class="form-text w-select"><option value="">Select a category</option><option value="First">First Choice</option><option value="Second">Second Choice</option><option value="Third">Third Choice</option></select></div>
              <div class="_30px-bottom-margin"><input type="text" class="form-text w-input" maxlength="256" name="Topics" data-name="Topics" placeholder="Topics" id="Topics" required=""></div><input type="submit" value="Submit" data-wait="Please wait..." class="submit-button w-button">
              <div class="difficulty">
                ...
                <div class="difficult-buttons">
                  <div class="difficulty-button">
                    <div class="heading-5 button unselected">BEGINNER</div>
                  </div>
                  <div class="difficulty-button selected">
                    <div class="heading-5 button selected">INTERMEDIATE</div>
                  </div>
                  <div class="difficulty-button">
                    <div class="heading-5 button unselected">ADVANCED</div>
                  </div>
                </div>
              </div>
            ...
            <div class="_100-percent-justify-start">
              ...
              <div class="w-form">
                <form id="email-form-2" name="email-form-2" data-name="Email Form 2">
                  <div class="_30px-bottom-margin"><input type="text" class="form-text w-input" maxlength="256" name="lesson-title" data-name="lesson title" placeholder="Title" id="lesson-title" required=""></div>
                  <div class="_30px-bottom-margin"><textarea id="lesson-description" name="lesson-description" placeholder="Lesson description" maxlength="5000" data-name="lesson description" required="" class="form-text description w-input"></textarea></div><input type="submit" value="Submit" data-wait="Please wait..." class="submit-button-2 w-button"></form>
                <div class="w-form-done">
                  <div>Thank you! Your submission has been received!</div>
                </div>
                <div class="w-form-fail">
              ...
              <div class="button secondary">
                <h1 class="form-button purple">Add Assignment</h1>
              </div>
              <div class="assignment w-form">
                <form id="email-form-2" name="email-form-2" data-name="Email Form 2" class="form-3">
                  <div class="div-block-53">
                    <div class="text-block-3">Required</div>
                    <div class="div-block-54">
                            <WhiteCheck v-if="isChecked"  class="check"/>                      
                      </div>
                  </div><textarea id="lesson-description-2" name="lesson-description-2" placeholder="Lesson description" maxlength="5000" data-name="Lesson Description 2" required="" class="form-text description assignment w-input"></textarea>
                  <div class="_50px-block">
      ...
      <div class="add-class-block">
        ...
        <div class="_40-side-padding">
          <div class="w-form">
            <form id="email-form" name="email-form" data-name="Email Form" class="form">
              <div class="_30px-bottom-margin"><input type="text" class="form-text w-input" maxlength="256" name="Final-Title" data-name="Final Title" placeholder="Title" id="Final-Title" required=""></div>
              <div class="_30px-bottom-margin"><textarea id="Description-5" name="Description" required="" maxlength="5000" data-name="Description" placeholder="Final guidelines" class="form-text description w-input"></textarea></div><input type="submit" value="Submit" data-wait="Please wait..." class="submit-button w-button"></form>
            <div class="w-form-done">
              <div>Thank you! Your submission has been received!</div>
            </div>
            <div class="w-form-fail">
            ...
            <div class="add-class-block">
              ...
              <div class="_40-side-padding">
                <div class="assignment w-form">
                      <form id="email-form-2" name="email-form-2" data-name="Email Form 2" class="form-3 border-none">
                    <div class="_30px-bottom-margin">
                      <input type="text" class="form-text w-input" maxlength="256" name="Final-Title-2" data-name="Final Title 2" placeholder="Title" id="Final-Title-2" required=""></div>
                      <quill-editor v-model="content" :options="config" ref="myQuillEditor">
                      </quill-editor>
                        <FileUpload />
                        <input type="submit" value="Submit" data-wait="Please wait..." class="submit-button-2 w-button"></form>
