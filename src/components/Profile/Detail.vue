                    ...
                    <div class="_30px-bottom-margin" v-for="(edu, index) in profile.education" :key="index">
                      <div class="horiz-left-align-justify-atart">
                        ...
                        <div class="flex-space-between">
                          ...
                          </div><img src="../../assets/pencil-edit-button.svg" v-if="loggedInUser._id === user._id" @click="openEducation(PROFILE_FORMS.EDUCATION, index)" height="14" alt=""></div>
                      </div>
                    </div>
                    <!-- <div class="_30px-bottom-margin">
                      <div class="horiz-left-align-justify-atart">
                        ...
                        <div>
                          <div class="space-between">
                            <div class="vert-justify-start-align-left min-width-400">
                              ...
                              <div class="_10px-botttom-margin">
                                <div class="heading-18"> {{months[new Date(work.from).getMonth()] + ' ' + new Date(work.from).getFullYear()}}   –
                                  {{work.currentlyWorkHere ?'Present' :  months[new Date(work.to).getMonth()] + ' ' + new Date(work.to).getFullYear()}}
                                  {{duration(work.from, work.to, work.currentlyWorkHere)}}
